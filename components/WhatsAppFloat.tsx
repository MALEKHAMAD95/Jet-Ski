  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="absolute -inset-2 rounded-full bg-[#25D366]/30 blur-xl" />

        <span className="relative flex w-14 h-14 sm:w-16 sm:h-16 items-center justify-center rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] shadow-2xl shadow-[#25D366]/50 group-hover:shadow-[#25D366]/70 transition-shadow ring-4 ring-white/40">
          <svg viewBox="0 0 32 32" className="w-7 h-7 sm:w-8 sm:h-8 drop-shadow-md" fill="white" aria-hidden="true">
          ...
          <motion.span
            ...
            className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center ring-2 ring-white shadow-lg"
          >
            1
          </motion.span>
        </span>

        <span className="hidden sm:block absolute right-full top-1/2 -translate-y-1/2 mr-4 whitespace-nowrap px-4 py-2 bg-white text-sky-900 text-sm font-semibold rounded-full opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none shadow-xl shadow-[#25D366]/20 border border-[#25D366]/30">
          Chat on WhatsApp →
        </span>
      </motion.a>
    </motion.div>
